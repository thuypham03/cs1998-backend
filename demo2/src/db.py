...
class DatabaseDriver(object):
    ...
    def get_all_tasks(self):
        """
        Using SQL, gets all tasks in the tasks table
        """
    ...
    def insert_task_table(self, desciption, done):
        """
    ...
    def get_task_by_id(self, id):
        """
        Using SQL, gets a task by its id
        """
    ...
    def update_task_by_id(self, id, description, done):
        """
        Using SQL, updates a task by its id
        """
        self.conn.execute("UPDATE tasks SET description=?, done=? WHERE id=?;", (description, done, id))
        self.conn.commit()

    def delete_task_by_id(self, id):
        """
        Using SQL, deletes a task by its id
        """
